.class public Landroid/support/v7/widget/AppCompatRatingBar_CF;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/AppCompatRatingBar_CF;->TINT_ATTRS:[I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/AppCompatRatingBar_CF;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Landroid/support/v7/widget/AppCompatRatingBar_CF;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 67
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatRatingBar_CF;->getContext()Landroid/content/Context;
    ...
    .line 72
    invoke-direct {p0, v1}, Landroid/support/v7/widget/AppCompatRatingBar_CF;->tileifyIndeterminate(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-virtual {p0, v2}, Landroid/support/v7/widget/AppCompatRatingBar_CF;->setIndeterminateDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 77
    invoke-direct {p0, v1, v4}, Landroid/support/v7/widget/AppCompatRatingBar_CF;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-virtual {p0, v2}, Landroid/support/v7/widget/AppCompatRatingBar_CF;->setProgressDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method private getDrawableShape()Landroid/graphics/drawable/shapes/Shape;
    ...
    .annotation runtime Lcom/alipay/euler/andfix/annotation/MethodReplace;
        clazz = "android.support.v7.widget.AppCompatRatingBar"
        method = "getDrawableShape"
    .end annotation
...
.method private tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 92
    invoke-direct {p0, v5, p2}, Landroid/support/v7/widget/AppCompatRatingBar_CF;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v12, v10}, Landroid/support/v7/widget/AppCompatRatingBar_CF;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v10, p0, Landroid/support/v7/widget/AppCompatRatingBar_CF;->mSampleTile:Landroid/graphics/Bitmap;

    if-nez v10, :cond_7

    .line 116
    iput-object v9, p0, Landroid/support/v7/widget/AppCompatRatingBar_CF;->mSampleTile:Landroid/graphics/Bitmap;

    .line 119
    :cond_7
    new-instance v8, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {p0}, Landroid/support/v7/widget/AppCompatRatingBar_CF;->getDrawableShape()Landroid/graphics/drawable/shapes/Shape;
...
.method private tileifyIndeterminate(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v5, v6}, Landroid/support/v7/widget/AppCompatRatingBar_CF;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method protected declared-synchronized onMeasure(II)V
    ...
    .line 162
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatRatingBar_CF;->mSampleTile:Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatRatingBar_CF;->getNumStars()I
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatRatingBar_CF;->getMeasuredHeight()I

    move-result v2

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/AppCompatRatingBar_CF;->setMeasuredDimension(II)V
    :try_end_0
