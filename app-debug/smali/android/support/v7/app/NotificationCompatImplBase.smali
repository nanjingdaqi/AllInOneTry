...
.method public static applyStandardTemplate(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;IILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIIIZ)Landroid/widget/RemoteViews;
    ...
    .line 294
    .end local v23    # "showLine2":Z
    .restart local v15    # "showLine2":Z
    :cond_1
    move/from16 v23, v15

    .end local v15    # "showLine2":Z
    .restart local v23    # "showLine2":Z
    sget v13, Landroid/support/v7/appcompat/R$id;->notification_background:I
    ...
    .line 365
    sget v13, Landroid/support/v7/appcompat/R$id;->info:I

    sget v14, Landroid/support/v7/appcompat/R$string;->status_bar_notification_info_overflow:I
    ...
    invoke-virtual {v12, v14, v0}, Landroid/widget/RemoteViews;->setTextViewText(ILjava/lang/CharSequence;)V
    ...
    sget v13, Landroid/support/v7/appcompat/R$id;->text:I

    const/4 v14, 0x0

    invoke-virtual {v12, v13, v14, v1}, Landroid/widget/RemoteViews;->setTextViewTextSize(IIF)V
    ...
    .line 404
    sget v13, Landroid/support/v7/appcompat/R$id;->chronometer:I
    ...
    .line 405
    invoke-virtual {v12, v13, v14, v0, v1}, Landroid/widget/RemoteViews;->setLong(ILjava/lang/String;J)V
    ...
    invoke-virtual {v12, v0, v1, v13}, Landroid/widget/RemoteViews;->setBoolean(ILjava/lang/String;Z)V
    ...
    invoke-virtual {v12, v0, v1, v9, v10}, Landroid/widget/RemoteViews;->setLong(ILjava/lang/String;J)V
...
.method public static applyStandardTemplateWithActions(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;IILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIIIZLjava/util/ArrayList;)Landroid/widget/RemoteViews;
    ...
    invoke-static {p0, v6}, Landroid/support/v7/app/NotificationCompatImplBase;->generateActionButton(Landroid/content/Context;Landroid/support/v4/app/NotificationCompat$Action;)Landroid/widget/RemoteViews;

    move-result-object v6

    .line 219
    .local v6, "button":Landroid/widget/RemoteViews;
    sget v8, Landroid/support/v7/appcompat/R$id;->actions:I

    invoke-virtual {v1, v8, v6}, Landroid/widget/RemoteViews;->addView(ILandroid/widget/RemoteViews;)V
...
.method private static generateContentViewMedia(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJILjava/util/List;[IZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    ...
    sget v11, Landroid/support/v7/appcompat/R$integer;->cancel_button_image_alpha:I
    ...
    .line 114
    invoke-virtual {v1, v3, v5, v10}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V
    ...
    sget v10, Landroid/support/v7/appcompat/R$id;->end_padder:I
...
.method public static generateMediaBigView(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIILjava/util/List;ZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    ...
    invoke-static {v7, v6}, Landroid/support/v7/app/NotificationCompatImplBase;->generateMediaActionButton(Landroid/content/Context;Landroid/support/v4/app/NotificationCompatBase$Action;)Landroid/widget/RemoteViews;

    move-result-object v6

    .line 157
    .local v6, "button":Landroid/widget/RemoteViews;
    sget v8, Landroid/support/v7/appcompat/R$id;->media_actions:I

    invoke-virtual {v2, v8, v6}, Landroid/widget/RemoteViews;->addView(ILandroid/widget/RemoteViews;)V
    ...
    .line 161
    sget v6, Landroid/support/v7/appcompat/R$id;->cancel_action:I
    ...
    .line 162
    invoke-virtual {v2, v3, v6, v8}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V
