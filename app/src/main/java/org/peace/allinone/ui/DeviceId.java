...
public class DeviceId {
    ...
    private static final File DIR = new File(Environment.getExternalStorageDirectory(), ".peace");
    ...
    public static String getDeviceId(Context context) {
        if (deviceId == null) {
            SharedPreferences sp = context.getSharedPreferences("peace", Context.MODE_PRIVATE);
