...
public class TriangleRectPopTextView extends TextView {
    ...
    public TriangleRectPopTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        backgroundColor = ta.getColor(0, getResources().getColor(R.color.blue));
        ta.recycle();
        ta = context.obtainStyledAttributes(attrs, R.styleable.TriangleRectPopTextView);
        triangleHeight = ta.getDimensionPixelSize(R.styleable.TriangleRectPopTextView_triangle_height, DimenUtil.dip2px(context, 8));
        radius = ta.getDimensionPixelSize(R.styleable.TriangleRectPopTextView_rect_radius, DimenUtil.dip2px(context, 4));
        ta.recycle();
