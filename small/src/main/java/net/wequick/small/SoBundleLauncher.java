...
public abstract class SoBundleLauncher extends BundleLauncher {
    ...
    public boolean preloadBundle(Bundle bundle) {
        ...
        Log.e("Small", "supporting: " + supporting);
    ...
    protected PackageInfo getPluginInfo(File plugin) {
        Log.e("Small", "plugin: " + plugin);
        Log.e("Small", "plugin: " + plugin.exists());
        ...
        Log.e("Small", "pluginInfo: " + pluginInfo + ", plugin: " + plugin.getPath());
